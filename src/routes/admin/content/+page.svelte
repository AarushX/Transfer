...
<section class="space-y-4">
	...
	>
		...
		<input class="rounded bg-slate-800 px-2 py-2" name="tier" type="number" min="1" value="1" />
		<input class="rounded bg-slate-800 px-2 py-2" name="ordering" type="number" min="0" value="0" />
		<input
			class="rounded bg-slate-800 px-2 py-2 md:col-span-2"
			name="physical_task"
			placeholder="Physical checkoff task"
		/>
		<textarea
			class="rounded bg-slate-800 px-2 py-2 md:col-span-2"
			name="description"
